...
public class SignUtil {
		...
		StringBuffer prestr = new StringBuffer();
			for (int i = 0; i < keys.size(); i++) {
				...
				if (params.get(key) instanceof String || params.get(key) instanceof Integer
						|| params.get(key) instanceof BigDecimal || params.get(key) instanceof Double|| params.get(key) instanceof Long) {
	...
	public static String getSign(Map<String, Object> params) {
		String sign = Md5Encrypt.md5(createLinkString(params) + "1", "utf-8");
		return sign;
	}
	...
	public static String getSign(List<Map<String, Object>> data) {
		String sign = Md5Encrypt.md5(createLinkString(data) + "1", "utf-8");
		return sign;
	}
